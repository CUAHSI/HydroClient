...
namespace HISWebClient.BusinessObjects
{
    ...
    {
        private static readonly string _ontologyFilename = "OntologyTree.xml";//Properties.Settings.Default.OntologyFilename;
        private static readonly string _ontologySynonymsFilename = "Synonyms.xml";//Properties.Settings.Default.SynonymsFilename;
