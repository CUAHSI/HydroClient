$(function () {
    ...
    $("#tree").fancytree({
        ...
        init: function (event, data) {            
            ...
            //Enable the Keywords button without doing any pre-loading...
            $('#' + 'btnSelectKeywords').prop('disabled', false);
            $('#' + 'glyphiconSpanSK').hide();
            $('#' + 'btnSelectKeywords').text('Select Keyword(s)');
        }
